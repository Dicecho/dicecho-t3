  ...
  dicecho: {
    ...
    styles: {
      light: {
        ...
        card: "oklch(0.9811 0.0093 286.2277)",
        "card-foreground": "oklch(0.1408 0.0044 285.8229)",
        popover: "oklch(1.0000 0 0)",
        "popover-foreground": "oklch(0.1408 0.0044 285.8229)",
        primary: "oklch(0.7115 0.1402 280.8633)",
        "primary-foreground": "oklch(1.0000 0 0)",
        secondary: "oklch(0.9622 0.0187 286.0437)",
        "secondary-foreground": "oklch(0.1408 0.0044 285.8229)",
        muted: "oklch(0.9622 0.0187 286.0437)",
        "muted-foreground": "oklch(0.5510 0.0234 264.3637)",
        accent: "oklch(0.9352 0.0323 285.7581)",
        ...
        "shadow-opacity": "0.1",
        "shadow-color": "#000000",
        "shadow-2xs": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.05)",
        "shadow-xs": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.05)",
        "shadow-sm": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.10), 0rem 1px 2px -1px hsl(0 0% 0% / 0.10)",
        shadow: "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.10), 0rem 1px 2px -1px hsl(0 0% 0% / 0.10)",
        "shadow-md": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.10), 0rem 2px 4px -1px hsl(0 0% 0% / 0.10)",
        "shadow-lg": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.10), 0rem 4px 6px -1px hsl(0 0% 0% / 0.10)",
        "shadow-xl": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.10), 0rem 8px 10px -1px hsl(0 0% 0% / 0.10)",
        "shadow-2xl": "0rem 0.25rem 1rem 0rem hsl(0 0% 0% / 0.25)",
        "tracking-normal": "0em",
        spacing: "0.25rem",
      },
      dark: {
        background: "oklch(0.2345 0.0274 274.7597)",
        foreground: "oklch(0.9246 0.0058 264.5312)",
        card: "oklch(0.2777 0.0317 276.3936)",
        "card-foreground": "oklch(0.9246 0.0058 264.5312)",
        popover: "oklch(0.2777 0.0317 276.3936)",
        "popover-foreground": "oklch(0.9246 0.0058 264.5312)",
        primary: "oklch(0.7115 0.1402 280.8633)",
        "primary-foreground": "oklch(1.0000 0 0)",
        secondary: "oklch(0.3652 0.0330 277.6386)",
        "secondary-foreground": "oklch(0.9246 0.0058 264.5312)",
        muted: "oklch(0.3652 0.0330 277.6386)",
        "muted-foreground": "oklch(0.7203 0.0221 273.9207)",
        accent: "oklch(0.3652 0.0330 277.6386)",
        "accent-foreground": "oklch(0.9246 0.0058 264.5312)",
        destructive: "oklch(0.6368 0.2078 25.3313)",
        "destructive-foreground": "oklch(1.0000 0 0)",
        border: "oklch(0.4432 0.0314 277.9958)",
        input: "oklch(0.4432 0.0314 277.9958)",
        ring: "oklch(0.7115 0.1402 280.8633)",
        "chart-1": "oklch(0.7115 0.1402 280.8633)",
        "chart-2": "oklch(0.6580 0.1747 279.3662)",
        "chart-3": "oklch(0.8868 0.1822 95.3305)",
        "chart-4": "oklch(0.7451 0.1577 151.5384)",
        "chart-5": "oklch(0.8562 0.0489 219.6543)",
        sidebar: "oklch(0.2483 0.0308 275.7448)",
        "sidebar-foreground": "oklch(0.9246 0.0058 264.5312)",
        "sidebar-primary": "oklch(0.7115 0.1402 280.8633)",
        "sidebar-primary-foreground": "oklch(1.0000 0 0)",
        "sidebar-accent": "oklch(0.3652 0.0330 277.6386)",
        "sidebar-accent-foreground": "oklch(0.9246 0.0058 264.5312)",
        "sidebar-border": "oklch(0.4432 0.0314 277.9958)",
        "sidebar-ring": "oklch(0.7115 0.1402 280.8633)",
        "font-sans": "sans-serif",
        "font-serif": "serif",
        "font-mono": "monospace",
        ...
        "shadow-opacity": "0.25",
        "shadow-color": "#000000",
        "shadow-2xs": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.13)",
        "shadow-xs": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.13)",
        "shadow-sm": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.25), 0rem 1px 2px -1px hsl(0 0% 0% / 0.25)",
        shadow: "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.25), 0rem 1px 2px -1px hsl(0 0% 0% / 0.25)",
        "shadow-md": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.25), 0rem 2px 4px -1px hsl(0 0% 0% / 0.25)",
        "shadow-lg": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.25), 0rem 4px 6px -1px hsl(0 0% 0% / 0.25)",
        "shadow-xl": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.25), 0rem 8px 10px -1px hsl(0 0% 0% / 0.25)",
        "shadow-2xl": "0rem 0.125rem 0.5rem 0rem hsl(0 0% 0% / 0.63)",
      },
    },
  },
  "modern-minimal": {
