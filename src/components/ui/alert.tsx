  ...
  "flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: "outline",
        className:
          "border-1 bg-yellow-100 text-yellow-600 dark:bg-yellow-600/10 dark:text-yellow-300 border-yellow-600 dark:border-yellow-300",
      },
      {
        variant: "mono",
        appearance: "outline",
      ...
      },
      {
        ...
        icon: "warning",
        className:
          "[&_[data-slot=alert-icon]]:text-[var(--color-warning-foreground,var(--color-yellow-600))] dark:[&_[data-slot=alert-icon]]:text-[var(--color-warning-foreground,var(--color-yellow-400))]",
      },
      {
        variant: "mono",
        icon: "success",
