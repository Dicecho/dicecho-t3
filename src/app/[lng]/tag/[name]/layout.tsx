...
export async function generateMetadata({
  ...
  const tagTitle = `${tag.name} | Dicecho`;
  // Optimize title for OG (50-60 chars)
  const ogTitle = `${tag.name} - ${tag.modCount} TRPG Scenarios | Dicecho`;
  const description =
    tag.description || `Explore ${tag.modCount} TRPG scenarios tagged with ${tag.name} on Dicecho`;
